...
| `TOKEN_ENC_KEY` | _(unset)_ | Enables connectors (including Bookkeep, Grimmory, Hardcover, and Readwise). 64 hex chars, a base64 32-byte key, or a ≥32-char passphrase. Encrypts stored connector credentials at rest; unset = connectors disabled. |
